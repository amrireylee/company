...
import com.empl.mgr.constant.*;
import com.empl.mgr.dao.*;
import com.empl.mgr.dto.*;
import com.empl.mgr.field.*;
import com.empl.mgr.model.*;
...
public class EmployeesServiceImpl implements EmployeesService {
	...
	public JSONReturn saveEmployeesInfo(EmployeesInfoDto dto, String acctName) {
        ...
        basic.setEmCensusRegister(analyzeAddress(dto.getRegister(), 0, AddressType.REGISTER, null, true)); // 解析户籍地址
        basic.setEmCurrentAddress(analyzeAddress(dto.getCurrent(), 0, AddressType.CURRENT, null, true)); // 解析现居住地址

        //System.out.println("3:------------"+dto.toString());
        employeesBasicDao.save(basic); // 保存员工基本信息
        //System.out.println("4:------------"+basic.toString());
